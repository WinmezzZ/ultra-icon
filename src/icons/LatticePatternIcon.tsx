...
const LatticePatternIconComponent = (p: SVGComponentProps) => {
...
LatticePatternIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const LatticePatternIcon = withWrapper(LatticePatternIconComponent);
