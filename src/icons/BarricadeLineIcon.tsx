...
const BarricadeLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
BarricadeLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const BarricadeLineIcon = withWrapper(BarricadeLineIconComponent);
