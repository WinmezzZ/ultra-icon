...
const HeadphoneFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
HeadphoneFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const HeadphoneFillIcon = withWrapper(HeadphoneFillIconComponent);
