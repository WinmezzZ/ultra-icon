...
const VipFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
VipFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const VipFillIcon = withWrapper(VipFillIconComponent);
export default VipFillIcon;
