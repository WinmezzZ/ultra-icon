...
const FileUploadLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
FileUploadLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const FileUploadLineIcon = withWrapper(FileUploadLineIconComponent);
