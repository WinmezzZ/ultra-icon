...
const PregnantWomenIconComponent = (p: SVGComponentProps) => {
...
PregnantWomenIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const PregnantWomenIcon = withWrapper(PregnantWomenIconComponent);
