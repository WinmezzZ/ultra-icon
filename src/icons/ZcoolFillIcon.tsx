...
const ZcoolFillIconComponent = (p: SVGComponentProps) => {
...
ZcoolFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const ZcoolFillIcon = withWrapper(ZcoolFillIconComponent);
export default ZcoolFillIcon;
