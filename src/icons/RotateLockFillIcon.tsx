...
const RotateLockFillIconComponent = (p: SVGComponentProps) => {
...
RotateLockFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const RotateLockFillIcon = withWrapper(RotateLockFillIconComponent);
