...
const RoundedCornerIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
RoundedCornerIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const RoundedCornerIcon = withWrapper(RoundedCornerIconComponent);
