...
const FutureBuildOneIconComponent = (p: SVGComponentProps) => {
...
FutureBuildOneIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const FutureBuildOneIcon = withWrapper(FutureBuildOneIconComponent);
