...
const HotelDoNotCleanIconComponent = (p: SVGComponentProps) => {
...
HotelDoNotCleanIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const HotelDoNotCleanIcon = withWrapper(HotelDoNotCleanIconComponent);
