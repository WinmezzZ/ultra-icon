...
const InnerShadowTopLeftIconComponent = (p: SVGComponentProps) => {
...
InnerShadowTopLeftIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const InnerShadowTopLeftIcon = withWrapper(InnerShadowTopLeftIconComponent);
