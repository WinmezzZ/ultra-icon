...
const FileProtectionOneIconComponent = (p: SVGComponentProps) => {
...
FileProtectionOneIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const FileProtectionOneIcon = withWrapper(FileProtectionOneIconComponent);
