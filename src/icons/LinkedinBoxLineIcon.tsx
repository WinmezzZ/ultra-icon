...
const LinkedinBoxLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
LinkedinBoxLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const LinkedinBoxLineIcon = withWrapper(LinkedinBoxLineIconComponent);
export default LinkedinBoxLineIcon;
