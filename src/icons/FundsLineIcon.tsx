...
const FundsLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
FundsLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const FundsLineIcon = withWrapper(FundsLineIconComponent);
export default FundsLineIcon;
