...
const BodyScanFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
    <svg
      viewBox="0 0 24 24"
...
BodyScanFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const BodyScanFillIcon = withWrapper(BodyScanFillIconComponent);
export default BodyScanFillIcon;
