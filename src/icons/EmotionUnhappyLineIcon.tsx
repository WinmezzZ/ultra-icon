...
const EmotionUnhappyLineIconComponent = (p: SVGComponentProps) => {
...
EmotionUnhappyLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const EmotionUnhappyLineIcon = withWrapper(EmotionUnhappyLineIconComponent);
export default EmotionUnhappyLineIcon;
