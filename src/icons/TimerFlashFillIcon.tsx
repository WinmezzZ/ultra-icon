...
const TimerFlashFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
TimerFlashFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const TimerFlashFillIcon = withWrapper(TimerFlashFillIconComponent);
export default TimerFlashFillIcon;
