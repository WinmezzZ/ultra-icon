...
const FolderShieldLineIconComponent = (p: SVGComponentProps) => {
...
FolderShieldLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const FolderShieldLineIcon = withWrapper(FolderShieldLineIconComponent);
