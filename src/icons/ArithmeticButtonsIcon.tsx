...
const ArithmeticButtonsIconComponent = (p: SVGComponentProps) => {
...
ArithmeticButtonsIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const ArithmeticButtonsIcon = withWrapper(ArithmeticButtonsIconComponent);
