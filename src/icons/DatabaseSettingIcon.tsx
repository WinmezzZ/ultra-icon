...
const DatabaseSettingIconComponent = (p: SVGComponentProps) => {
  ...
  return (
    <svg fill="none" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" width={size} height={size} {...props}>
      ...
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={4}
        d="m34 27 3.464 2v4L34 35l-3.464-2v-4L34 27Z"
      />
    </svg>
  );
};

DatabaseSettingIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const DatabaseSettingIcon = withWrapper(DatabaseSettingIconComponent);
