...
const FileWarningLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
FileWarningLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const FileWarningLineIcon = withWrapper(FileWarningLineIconComponent);
