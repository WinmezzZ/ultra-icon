...
const UserSettingsLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
UserSettingsLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const UserSettingsLineIcon = withWrapper(UserSettingsLineIconComponent);
export default UserSettingsLineIcon;
