...
const Home5LineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
Home5LineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const Home5LineIcon = withWrapper(Home5LineIconComponent);
export default Home5LineIcon;
