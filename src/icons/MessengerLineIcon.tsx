...
const MessengerLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
MessengerLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const MessengerLineIcon = withWrapper(MessengerLineIconComponent);
