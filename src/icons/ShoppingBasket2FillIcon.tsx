...
const ShoppingBasket2FillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
ShoppingBasket2FillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const ShoppingBasket2FillIcon = withWrapper(ShoppingBasket2FillIconComponent);
