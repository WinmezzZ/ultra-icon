    ...
    <span css={iconStyle} className="ultra-icon">
      ...
      >
        <rect
          ...
          rx={2}
        />
        <path stroke="#fff" strokeLinecap="round" strokeLinejoin="round" strokeWidth={4} d="M4 20h40" />
        <path stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth={4} d="M4 17v6m40-6v6" />
        <path stroke="#fff" strokeLinecap="round" strokeLinejoin="round" strokeWidth={4} d="M29 29h8" />
      </svg>
    </span>
  );
};
