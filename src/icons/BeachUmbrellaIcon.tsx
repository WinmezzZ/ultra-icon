...
const BeachUmbrellaIconComponent = (p: SVGComponentProps) => {
...
BeachUmbrellaIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const BeachUmbrellaIcon = withWrapper(BeachUmbrellaIconComponent);
