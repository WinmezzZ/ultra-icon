...
const Coupon3FillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
Coupon3FillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const Coupon3FillIcon = withWrapper(Coupon3FillIconComponent);
export default Coupon3FillIcon;
