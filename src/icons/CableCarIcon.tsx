...
const CableCarIconComponent = (p: SVGComponentProps) => {
  ...
  return (
    <svg fill="none" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" width={size} height={size} {...props}>
      ...
      />
      <path stroke="#333" strokeLinecap="round" strokeLinejoin="round" strokeWidth={4} d="M9 23h9v10H8m31-10H25v9h15" />
      <path
        stroke="#000"
        strokeLinecap="round"
...
CableCarIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const CableCarIcon = withWrapper(CableCarIconComponent);
