...
const MoneyEuroCircleLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
    <svg
      viewBox="0 0 24 24"
...
MoneyEuroCircleLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const MoneyEuroCircleLineIcon = withWrapper(MoneyEuroCircleLineIconComponent);
export default MoneyEuroCircleLineIcon;
