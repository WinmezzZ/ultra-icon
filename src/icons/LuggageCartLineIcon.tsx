...
const LuggageCartLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
LuggageCartLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const LuggageCartLineIcon = withWrapper(LuggageCartLineIconComponent);
