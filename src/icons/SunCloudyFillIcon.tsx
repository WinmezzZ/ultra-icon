...
const SunCloudyFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
SunCloudyFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const SunCloudyFillIcon = withWrapper(SunCloudyFillIconComponent);
export default SunCloudyFillIcon;
