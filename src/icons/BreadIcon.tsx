  ...
  return (
    <span css={iconStyle} className="ultra-icon">
      ...
      >
        ...
        <path stroke="#fff" strokeLinecap="round" strokeWidth={4} d="M14 22v4" />
        <path stroke="#000" strokeLinecap="round" strokeWidth={4} d="M36 9v4" />
        <path stroke="#fff" strokeLinecap="round" strokeWidth={4} d="M34 22v4" />
        <path stroke="#000" strokeLinecap="round" strokeWidth={4} d="M24 7v6" />
        <path stroke="#fff" strokeLinecap="round" strokeWidth={4} d="M24 20v8" />
        <path
          stroke="#000"
          strokeLinecap="round"
          strokeWidth={4}
