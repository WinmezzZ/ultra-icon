...
const Screenshot2LineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
Screenshot2LineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const Screenshot2LineIcon = withWrapper(Screenshot2LineIconComponent);
export default Screenshot2LineIcon;
