...
const CalendarTodoLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
CalendarTodoLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const CalendarTodoLineIcon = withWrapper(CalendarTodoLineIconComponent);
