...
const RestaurantFillIconComponent = (p: SVGComponentProps) => {
...
RestaurantFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const RestaurantFillIcon = withWrapper(RestaurantFillIconComponent);
