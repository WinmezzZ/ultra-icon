...
const UserToUserTransmissionIconComponent = (p: SVGComponentProps) => {
...
UserToUserTransmissionIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const UserToUserTransmissionIcon = withWrapper(UserToUserTransmissionIconComponent);
