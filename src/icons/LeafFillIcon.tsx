...
const LeafFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
LeafFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const LeafFillIcon = withWrapper(LeafFillIconComponent);
export default LeafFillIcon;
