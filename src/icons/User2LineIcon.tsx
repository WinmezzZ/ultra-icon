...
const User2LineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
User2LineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const User2LineIcon = withWrapper(User2LineIconComponent);
export default User2LineIcon;
