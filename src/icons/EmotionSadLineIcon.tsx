...
const EmotionSadLineIconComponent = (p: SVGComponentProps) => {
...
EmotionSadLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const EmotionSadLineIcon = withWrapper(EmotionSadLineIconComponent);
export default EmotionSadLineIcon;
