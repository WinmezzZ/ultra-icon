...
const PencilRulerLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
PencilRulerLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const PencilRulerLineIcon = withWrapper(PencilRulerLineIconComponent);
