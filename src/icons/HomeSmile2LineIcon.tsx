...
const HomeSmile2LineIconComponent = (p: SVGComponentProps) => {
...
HomeSmile2LineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const HomeSmile2LineIcon = withWrapper(HomeSmile2LineIconComponent);
export default HomeSmile2LineIcon;
