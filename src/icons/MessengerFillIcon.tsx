...
const MessengerFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
MessengerFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const MessengerFillIcon = withWrapper(MessengerFillIconComponent);
