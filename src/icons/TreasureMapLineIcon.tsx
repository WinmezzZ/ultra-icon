...
const TreasureMapLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
TreasureMapLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const TreasureMapLineIcon = withWrapper(TreasureMapLineIconComponent);
export default TreasureMapLineIcon;
