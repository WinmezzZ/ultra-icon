...
const VipDiamondLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
VipDiamondLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const VipDiamondLineIcon = withWrapper(VipDiamondLineIconComponent);
export default VipDiamondLineIcon;
