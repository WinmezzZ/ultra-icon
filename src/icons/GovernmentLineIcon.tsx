...
const GovernmentLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
GovernmentLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const GovernmentLineIcon = withWrapper(GovernmentLineIconComponent);
