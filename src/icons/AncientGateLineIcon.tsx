...
const AncientGateLineIconComponent = (p: SVGComponentProps) => {
...
AncientGateLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const AncientGateLineIcon = withWrapper(AncientGateLineIconComponent);
export default AncientGateLineIcon;
