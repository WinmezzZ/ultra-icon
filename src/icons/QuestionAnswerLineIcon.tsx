...
const QuestionAnswerLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
QuestionAnswerLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const QuestionAnswerLineIcon = withWrapper(QuestionAnswerLineIconComponent);
