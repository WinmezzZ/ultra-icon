...
const ProjectorThreeIconComponent = (p: SVGComponentProps) => {
...
ProjectorThreeIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const ProjectorThreeIcon = withWrapper(ProjectorThreeIconComponent);
