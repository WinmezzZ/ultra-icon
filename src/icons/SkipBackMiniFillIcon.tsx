...
const SkipBackMiniFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
SkipBackMiniFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const SkipBackMiniFillIcon = withWrapper(SkipBackMiniFillIconComponent);
