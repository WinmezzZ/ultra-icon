...
const Polaroid2LineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
Polaroid2LineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const Polaroid2LineIcon = withWrapper(Polaroid2LineIconComponent);
export default Polaroid2LineIcon;
