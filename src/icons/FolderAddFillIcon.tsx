...
const FolderAddFillIconComponent = (p: SVGComponentProps) => {
...
FolderAddFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const FolderAddFillIcon = withWrapper(FolderAddFillIconComponent);
