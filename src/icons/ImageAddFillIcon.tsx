...
const ImageAddFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
ImageAddFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const ImageAddFillIcon = withWrapper(ImageAddFillIconComponent);
export default ImageAddFillIcon;
