...
const TwoDimensionalCodeTwoIconComponent = (p: SVGComponentProps) => {
...
TwoDimensionalCodeTwoIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const TwoDimensionalCodeTwoIcon = withWrapper(TwoDimensionalCodeTwoIconComponent);
