...
const CommunityLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
CommunityLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const CommunityLineIcon = withWrapper(CommunityLineIconComponent);
