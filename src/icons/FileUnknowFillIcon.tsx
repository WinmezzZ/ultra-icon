...
const FileUnknowFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
FileUnknowFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const FileUnknowFillIcon = withWrapper(FileUnknowFillIconComponent);
