...
const FileDamageLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
FileDamageLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const FileDamageLineIcon = withWrapper(FileDamageLineIconComponent);
