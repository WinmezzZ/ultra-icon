...
const BilliardsFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
BilliardsFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const BilliardsFillIcon = withWrapper(BilliardsFillIconComponent);
export default BilliardsFillIcon;
