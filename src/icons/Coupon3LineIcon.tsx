...
const Coupon3LineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
    <svg
      viewBox="0 0 24 24"
...
Coupon3LineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const Coupon3LineIcon = withWrapper(Coupon3LineIconComponent);
export default Coupon3LineIcon;
