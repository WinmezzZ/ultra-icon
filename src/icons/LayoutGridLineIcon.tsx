...
const LayoutGridLineIconComponent = (p: SVGComponentProps) => {
...
LayoutGridLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const LayoutGridLineIcon = withWrapper(LayoutGridLineIconComponent);
