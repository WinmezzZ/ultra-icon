...
const DataNullIconComponent = (p: SVGComponentProps) => {
...
DataNullIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const DataNullIcon = withWrapper(DataNullIconComponent);
export default DataNullIcon;
