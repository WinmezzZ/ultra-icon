...
const CameraLensLineIconComponent = (p: SVGComponentProps) => {
...
CameraLensLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const CameraLensLineIcon = withWrapper(CameraLensLineIconComponent);
