...
const CompassesFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
CompassesFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const CompassesFillIcon = withWrapper(CompassesFillIconComponent);
export default CompassesFillIcon;
