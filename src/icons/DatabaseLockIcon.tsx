...
const DatabaseLockIconComponent = (p: SVGComponentProps) => {
  ...
  return (
    <svg fill="none" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" width={size} height={size} {...props}>
      ...
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={4}
        d="M39 31a5 5 0 0 1-10 0h10Zm-5-5a3 3 0 0 1 3 3v2h-6v-2a3 3 0 0 1 3-3Z"
      />
    </svg>
  );
};

DatabaseLockIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const DatabaseLockIcon = withWrapper(DatabaseLockIconComponent);
