...
const CreativeCommonsZeroFillIconComponent = (p: SVGComponentProps) => {
...
CreativeCommonsZeroFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const CreativeCommonsZeroFillIcon = withWrapper(CreativeCommonsZeroFillIconComponent);
export default CreativeCommonsZeroFillIcon;
