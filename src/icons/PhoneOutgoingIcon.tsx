...
const PhoneOutgoingIconComponent = (p: SVGComponentProps) => {
...
PhoneOutgoingIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const PhoneOutgoingIcon = withWrapper(PhoneOutgoingIconComponent);
