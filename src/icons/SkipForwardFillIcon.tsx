...
const SkipForwardFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
SkipForwardFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const SkipForwardFillIcon = withWrapper(SkipForwardFillIconComponent);
