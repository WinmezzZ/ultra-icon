...
const VolumeMuteLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
VolumeMuteLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const VolumeMuteLineIcon = withWrapper(VolumeMuteLineIconComponent);
export default VolumeMuteLineIcon;
