...
const Compasses2FillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
    <svg
      viewBox="0 0 24 24"
...
Compasses2FillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const Compasses2FillIcon = withWrapper(Compasses2FillIconComponent);
export default Compasses2FillIcon;
