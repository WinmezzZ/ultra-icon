...
const Polaroid2FillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
Polaroid2FillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const Polaroid2FillIcon = withWrapper(Polaroid2FillIconComponent);
export default Polaroid2FillIcon;
