...
const WirelessChargingFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
    <svg
      viewBox="0 0 24 24"
...
WirelessChargingFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const WirelessChargingFillIcon = withWrapper(WirelessChargingFillIconComponent);
export default WirelessChargingFillIcon;
