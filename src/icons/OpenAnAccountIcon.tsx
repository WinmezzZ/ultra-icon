...
const OpenAnAccountIconComponent = (p: SVGComponentProps) => {
...
OpenAnAccountIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const OpenAnAccountIcon = withWrapper(OpenAnAccountIconComponent);
