...
const SurgicalMaskFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
SurgicalMaskFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const SurgicalMaskFillIcon = withWrapper(SurgicalMaskFillIconComponent);
export default SurgicalMaskFillIcon;
