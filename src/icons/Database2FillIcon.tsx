...
const Database2FillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
Database2FillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const Database2FillIcon = withWrapper(Database2FillIconComponent);
export default Database2FillIcon;
