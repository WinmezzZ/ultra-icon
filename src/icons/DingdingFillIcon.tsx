...
const DingdingFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
    <svg
      viewBox="0 0 24 24"
...
DingdingFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const DingdingFillIcon = withWrapper(DingdingFillIconComponent);
export default DingdingFillIcon;
