...
const PhoneIncomingIconComponent = (p: SVGComponentProps) => {
...
PhoneIncomingIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const PhoneIncomingIcon = withWrapper(PhoneIncomingIconComponent);
