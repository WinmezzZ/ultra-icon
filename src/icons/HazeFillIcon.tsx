...
const HazeFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
HazeFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const HazeFillIcon = withWrapper(HazeFillIconComponent);
export default HazeFillIcon;
