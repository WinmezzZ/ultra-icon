...
const BlurOffLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
BlurOffLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const BlurOffLineIcon = withWrapper(BlurOffLineIconComponent);
export default BlurOffLineIcon;
