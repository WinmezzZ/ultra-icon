...
const UpdateRotationIconComponent = (p: SVGComponentProps) => {
...
UpdateRotationIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const UpdateRotationIcon = withWrapper(UpdateRotationIconComponent);
