...
const FourPointConnectionIconComponent = (p: SVGComponentProps) => {
...
FourPointConnectionIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const FourPointConnectionIcon = withWrapper(FourPointConnectionIconComponent);
