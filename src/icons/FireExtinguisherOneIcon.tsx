  ...
  return (
    <span css={iconStyle} className="ultra-icon">
      ...
      >
        ...
        />
        <path stroke="#fff" strokeLinecap="round" strokeLinejoin="round" strokeWidth={4} d="M24 24v10" />
        <path fill="#2F88FF" stroke="#000" strokeLinejoin="round" strokeWidth={4} d="M20 5h9v4h-9zm9 0 9-1v6l-9-1V5Z" />
        <path
          stroke="#000"
          strokeLinecap="round"
          strokeLinejoin="round"
