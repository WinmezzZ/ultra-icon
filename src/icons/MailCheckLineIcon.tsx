...
const MailCheckLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
MailCheckLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const MailCheckLineIcon = withWrapper(MailCheckLineIconComponent);
