...
const ChatSmileFillIconComponent = (p: SVGComponentProps) => {
...
ChatSmileFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const ChatSmileFillIcon = withWrapper(ChatSmileFillIconComponent);
