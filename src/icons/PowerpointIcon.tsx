  ...
  return (
    <span css={iconStyle} className="ultra-icon">
      ...
      >
        ...
        <path stroke="#fff" strokeLinecap="round" strokeLinejoin="round" strokeWidth={4} d="M19 15h10v10H19z" />
        <path stroke="#fff" strokeLinecap="round" strokeWidth={4} d="M19 33V15" />
      </svg>
    </span>
  );
};
