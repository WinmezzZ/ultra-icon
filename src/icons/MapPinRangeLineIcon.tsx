...
const MapPinRangeLineIconComponent = (p: SVGComponentProps) => {
...
MapPinRangeLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const MapPinRangeLineIcon = withWrapper(MapPinRangeLineIconComponent);
export default MapPinRangeLineIcon;
