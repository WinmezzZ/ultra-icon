...
const FilePpt2FillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
    <svg
      viewBox="0 0 24 24"
...
FilePpt2FillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const FilePpt2FillIcon = withWrapper(FilePpt2FillIconComponent);
export default FilePpt2FillIcon;
