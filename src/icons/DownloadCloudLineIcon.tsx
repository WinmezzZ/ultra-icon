...
const DownloadCloudLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
DownloadCloudLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const DownloadCloudLineIcon = withWrapper(DownloadCloudLineIconComponent);
