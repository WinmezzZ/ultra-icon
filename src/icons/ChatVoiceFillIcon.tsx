...
const ChatVoiceFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
ChatVoiceFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const ChatVoiceFillIcon = withWrapper(ChatVoiceFillIconComponent);
