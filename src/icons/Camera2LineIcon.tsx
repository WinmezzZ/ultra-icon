...
const Camera2LineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
Camera2LineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const Camera2LineIcon = withWrapper(Camera2LineIconComponent);
export default Camera2LineIcon;
