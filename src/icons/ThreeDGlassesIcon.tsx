...
const ThreeDGlassesIconComponent = (p: SVGComponentProps) => {
...
ThreeDGlassesIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const ThreeDGlassesIcon = withWrapper(ThreeDGlassesIconComponent);
