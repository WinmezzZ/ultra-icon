...
const UserFollowLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
UserFollowLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const UserFollowLineIcon = withWrapper(UserFollowLineIconComponent);
