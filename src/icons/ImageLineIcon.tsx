...
const ImageLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
ImageLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const ImageLineIcon = withWrapper(ImageLineIconComponent);
export default ImageLineIcon;
