...
const RegisteredLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
RegisteredLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const RegisteredLineIcon = withWrapper(RegisteredLineIconComponent);
