...
const PencilRuler2LineIconComponent = (p: SVGComponentProps) => {
...
PencilRuler2LineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const PencilRuler2LineIcon = withWrapper(PencilRuler2LineIconComponent);
