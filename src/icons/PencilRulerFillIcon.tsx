...
const PencilRulerFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
PencilRulerFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const PencilRulerFillIcon = withWrapper(PencilRulerFillIconComponent);
