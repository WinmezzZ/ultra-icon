...
const AlipayFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
AlipayFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const AlipayFillIcon = withWrapper(AlipayFillIconComponent);
export default AlipayFillIcon;
