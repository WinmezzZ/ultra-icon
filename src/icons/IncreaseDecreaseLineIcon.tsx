...
const IncreaseDecreaseLineIconComponent = (p: SVGComponentProps) => {
...
IncreaseDecreaseLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const IncreaseDecreaseLineIcon = withWrapper(IncreaseDecreaseLineIconComponent);
