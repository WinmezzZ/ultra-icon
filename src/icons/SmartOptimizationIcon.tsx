...
const SmartOptimizationIconComponent = (p: SVGComponentProps) => {
...
SmartOptimizationIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const SmartOptimizationIcon = withWrapper(SmartOptimizationIconComponent);
