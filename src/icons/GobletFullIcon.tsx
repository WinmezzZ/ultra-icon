...
const GobletFullIconComponent = (p: SVGComponentProps) => {
  ...
  return (
    <svg fill="none" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" width={size} height={size} {...props}>
      ...
      />
      <path stroke="#333" strokeLinecap="round" strokeLinejoin="round" strokeWidth={4} d="M35 16s-7 3-12 0-12 0-12 0" />
      <path
        stroke="#000"
        strokeLinecap="round"
        strokeLinejoin="round"
...
GobletFullIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const GobletFullIcon = withWrapper(GobletFullIconComponent);
