...
const XingFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
XingFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const XingFillIcon = withWrapper(XingFillIconComponent);
export default XingFillIcon;
