...
const FigmaMaskIconComponent = (p: SVGComponentProps) => {
...
FigmaMaskIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const FigmaMaskIcon = withWrapper(FigmaMaskIconComponent);
export default FigmaMaskIcon;
