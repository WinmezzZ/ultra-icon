...
const IwatchIconComponent = (p: SVGComponentProps) => {
  const { size, filled, ...props } = p;
  return (
    <svg fill="none" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" width={size} height={size} {...props}>
      <path fill="#fff" fillOpacity={0.01} d="M0 0h48v48H0z" />
      <path fill="null" stroke="#000" strokeLinejoin="round" strokeWidth={4} d="M36 12H10v24h26V12Z" />
      <path fill="null" stroke="#333" strokeLinejoin="round" strokeWidth={4} d="M27 24a4 4 0 1 0-8 0 4 4 0 0 0 8 0Z" />
      <path
        stroke="#000"
        strokeLinecap="round"
        strokeWidth={4}
...
IwatchIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const IwatchIcon = withWrapper(IwatchIconComponent);
