...
const VidiconLineIconComponent = (p: SVGComponentProps) => {
...
VidiconLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const VidiconLineIcon = withWrapper(VidiconLineIconComponent);
export default VidiconLineIcon;
