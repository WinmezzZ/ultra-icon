...
const RewindFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
RewindFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const RewindFillIcon = withWrapper(RewindFillIconComponent);
export default RewindFillIcon;
