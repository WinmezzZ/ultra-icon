...
const GitRepositoryLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
GitRepositoryLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const GitRepositoryLineIcon = withWrapper(GitRepositoryLineIconComponent);
