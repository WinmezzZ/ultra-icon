...
const FirefoxLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
FirefoxLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const FirefoxLineIcon = withWrapper(FirefoxLineIconComponent);
export default FirefoxLineIcon;
