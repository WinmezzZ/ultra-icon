...
const EndpointDisplacementIconComponent = (p: SVGComponentProps) => {
...
EndpointDisplacementIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const EndpointDisplacementIcon = withWrapper(EndpointDisplacementIconComponent);
