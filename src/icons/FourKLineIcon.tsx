...
const FourKLineIconComponent = (p: SVGComponentProps) => {
...
FourKLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const FourKLineIcon = withWrapper(FourKLineIconComponent);
export default FourKLineIcon;
