...
const FileUserLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
FileUserLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const FileUserLineIcon = withWrapper(FileUserLineIconComponent);
export default FileUserLineIcon;
