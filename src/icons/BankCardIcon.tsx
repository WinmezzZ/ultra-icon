  ...
  return (
    <span css={iconStyle} className="ultra-icon">
      ...
      >
        ...
        />
        <path stroke="#fff" strokeLinecap="square" strokeLinejoin="round" strokeWidth={4} d="M4 16h40" />
        <path stroke="#fff" strokeLinecap="round" strokeLinejoin="round" strokeWidth={4} d="M27 32h9" />
