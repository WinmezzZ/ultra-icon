...
const DatabaseSearchIconComponent = (p: SVGComponentProps) => {
  ...
  return (
    <svg fill="none" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" width={size} height={size} {...props}>
      ...
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={4}
        d="M4 28c0 2.761 6.716 5 15 5 1.807 0 3.54-.106 5.144-.302M4 20c0 2.761 6.716 5 15 5 2.756 0 5.339-.248 7.558-.68m10.27 9.508L41 38"
      />
      <path
        fill="null"
        stroke="#000"
        ...
        strokeLinejoin="round"
        strokeWidth={4}
        d="M38 31a3.987 3.987 0 0 1-1.172 2.828A4 4 0 1 1 38 31Z"
      />
    </svg>
  );
};

DatabaseSearchIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const DatabaseSearchIcon = withWrapper(DatabaseSearchIconComponent);
