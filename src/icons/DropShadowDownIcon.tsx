...
const DropShadowDownIconComponent = (p: SVGComponentProps) => {
...
DropShadowDownIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const DropShadowDownIcon = withWrapper(DropShadowDownIconComponent);
