...
const MaslowPyramidsIconComponent = (p: SVGComponentProps) => {
...
MaslowPyramidsIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const MaslowPyramidsIcon = withWrapper(MaslowPyramidsIconComponent);
