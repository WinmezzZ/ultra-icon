...
const FolderMusicOneIconComponent = (p: SVGComponentProps) => {
...
FolderMusicOneIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const FolderMusicOneIcon = withWrapper(FolderMusicOneIconComponent);
