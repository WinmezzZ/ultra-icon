...
const PaletteFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
PaletteFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const PaletteFillIcon = withWrapper(PaletteFillIconComponent);
export default PaletteFillIcon;
