...
const ConvergingGatewayIconComponent = (p: SVGComponentProps) => {
...
ConvergingGatewayIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const ConvergingGatewayIcon = withWrapper(ConvergingGatewayIconComponent);
