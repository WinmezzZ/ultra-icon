...
const LinkCloudSucessIconComponent = (p: SVGComponentProps) => {
...
LinkCloudSucessIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const LinkCloudSucessIcon = withWrapper(LinkCloudSucessIconComponent);
