...
const VimeoFillIconComponent = (p: SVGComponentProps) => {
...
VimeoFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const VimeoFillIcon = withWrapper(VimeoFillIconComponent);
export default VimeoFillIcon;
