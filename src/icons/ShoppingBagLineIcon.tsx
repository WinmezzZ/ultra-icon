...
const ShoppingBagLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
ShoppingBagLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const ShoppingBagLineIcon = withWrapper(ShoppingBagLineIconComponent);
