...
const Movie2LineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
Movie2LineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const Movie2LineIcon = withWrapper(Movie2LineIconComponent);
export default Movie2LineIcon;
