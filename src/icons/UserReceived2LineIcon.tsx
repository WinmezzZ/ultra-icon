...
const UserReceived2LineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
    <svg
      viewBox="0 0 24 24"
...
UserReceived2LineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const UserReceived2LineIcon = withWrapper(UserReceived2LineIconComponent);
export default UserReceived2LineIcon;
