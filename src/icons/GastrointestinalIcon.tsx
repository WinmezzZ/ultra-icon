...
const GastrointestinalIconComponent = (p: SVGComponentProps) => {
...
GastrointestinalIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const GastrointestinalIcon = withWrapper(GastrointestinalIconComponent);
