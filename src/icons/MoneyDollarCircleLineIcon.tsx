...
const MoneyDollarCircleLineIconComponent = (p: SVGComponentProps) => {
...
MoneyDollarCircleLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const MoneyDollarCircleLineIcon = withWrapper(MoneyDollarCircleLineIconComponent);
export default MoneyDollarCircleLineIcon;
