...
const WeiboLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
WeiboLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const WeiboLineIcon = withWrapper(WeiboLineIconComponent);
export default WeiboLineIcon;
