...
const EntertainmentIconComponent = (p: SVGComponentProps) => {
...
EntertainmentIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const EntertainmentIcon = withWrapper(EntertainmentIconComponent);
