...
const Speaker2LineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
Speaker2LineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const Speaker2LineIcon = withWrapper(Speaker2LineIconComponent);
export default Speaker2LineIcon;
