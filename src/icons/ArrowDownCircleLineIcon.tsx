...
const ArrowDownCircleLineIconComponent = (p: SVGComponentProps) => {
...
ArrowDownCircleLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const ArrowDownCircleLineIcon = withWrapper(ArrowDownCircleLineIconComponent);
