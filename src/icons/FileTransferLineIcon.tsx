...
const FileTransferLineIconComponent = (p: SVGComponentProps) => {
...
FileTransferLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const FileTransferLineIcon = withWrapper(FileTransferLineIconComponent);
