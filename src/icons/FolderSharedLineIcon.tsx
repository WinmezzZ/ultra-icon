...
const FolderSharedLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
FolderSharedLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const FolderSharedLineIcon = withWrapper(FolderSharedLineIconComponent);
