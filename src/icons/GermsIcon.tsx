...
const GermsIconComponent = (p: SVGComponentProps) => {
  ...
  return (
    <svg fill="none" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" width={size} height={size} {...props}>
      ...
      <path
        ...
        clipRule="evenodd"
      />
      <path fill="null" stroke="#333" strokeLinejoin="round" strokeWidth={4} d="M29 29a4 4 0 1 0 0-8 4 4 0 0 0 0 8Z" />
      <path fill="#fff" d="M16.5 26a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5Z" />
    </svg>
  );
};

GermsIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const GermsIcon = withWrapper(GermsIconComponent);
