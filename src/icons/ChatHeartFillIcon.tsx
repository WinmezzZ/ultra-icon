...
const ChatHeartFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
ChatHeartFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const ChatHeartFillIcon = withWrapper(ChatHeartFillIconComponent);
