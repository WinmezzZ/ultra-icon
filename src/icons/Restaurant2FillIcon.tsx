...
const Restaurant2FillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
    <svg
      viewBox="0 0 24 24"
...
Restaurant2FillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const Restaurant2FillIcon = withWrapper(Restaurant2FillIconComponent);
export default Restaurant2FillIcon;
