...
const FileSettingsLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
FileSettingsLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const FileSettingsLineIcon = withWrapper(FileSettingsLineIconComponent);
export default FileSettingsLineIcon;
