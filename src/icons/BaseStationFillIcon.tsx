...
const BaseStationFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
BaseStationFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const BaseStationFillIcon = withWrapper(BaseStationFillIconComponent);
export default BaseStationFillIcon;
