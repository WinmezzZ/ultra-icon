...
const EmotionHappyFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
EmotionHappyFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const EmotionHappyFillIcon = withWrapper(EmotionHappyFillIconComponent);
export default EmotionHappyFillIcon;
