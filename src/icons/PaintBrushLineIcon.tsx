...
const PaintBrushLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
PaintBrushLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const PaintBrushLineIcon = withWrapper(PaintBrushLineIconComponent);
