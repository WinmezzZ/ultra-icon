...
const ReverseLensOneIconComponent = (p: SVGComponentProps) => {
...
ReverseLensOneIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const ReverseLensOneIcon = withWrapper(ReverseLensOneIconComponent);
