...
const MoonCloudyLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
MoonCloudyLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const MoonCloudyLineIcon = withWrapper(MoonCloudyLineIconComponent);
export default MoonCloudyLineIcon;
