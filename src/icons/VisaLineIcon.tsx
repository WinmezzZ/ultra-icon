...
const VisaLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
VisaLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const VisaLineIcon = withWrapper(VisaLineIconComponent);
export default VisaLineIcon;
