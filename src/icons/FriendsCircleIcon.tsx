...
const FriendsCircleIconComponent = (p: SVGComponentProps) => {
...
FriendsCircleIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const FriendsCircleIcon = withWrapper(FriendsCircleIconComponent);
