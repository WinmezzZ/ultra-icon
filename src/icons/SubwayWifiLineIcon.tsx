...
const SubwayWifiLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
    <svg
      viewBox="0 0 24 24"
...
SubwayWifiLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const SubwayWifiLineIcon = withWrapper(SubwayWifiLineIconComponent);
export default SubwayWifiLineIcon;
