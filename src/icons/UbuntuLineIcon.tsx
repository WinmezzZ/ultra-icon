...
const UbuntuLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
UbuntuLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const UbuntuLineIcon = withWrapper(UbuntuLineIconComponent);
export default UbuntuLineIcon;
