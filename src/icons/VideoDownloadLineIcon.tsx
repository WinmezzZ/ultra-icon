...
const VideoDownloadLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
VideoDownloadLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const VideoDownloadLineIcon = withWrapper(VideoDownloadLineIconComponent);
export default VideoDownloadLineIcon;
