...
const FutureBuildThreeIconComponent = (p: SVGComponentProps) => {
...
FutureBuildThreeIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const FutureBuildThreeIcon = withWrapper(FutureBuildThreeIconComponent);
