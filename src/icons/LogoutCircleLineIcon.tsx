...
const LogoutCircleLineIconComponent = (p: SVGComponentProps) => {
...
LogoutCircleLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const LogoutCircleLineIcon = withWrapper(LogoutCircleLineIconComponent);
