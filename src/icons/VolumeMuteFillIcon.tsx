...
const VolumeMuteFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
VolumeMuteFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const VolumeMuteFillIcon = withWrapper(VolumeMuteFillIconComponent);
