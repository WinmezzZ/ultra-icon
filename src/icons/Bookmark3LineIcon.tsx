...
const Bookmark3LineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
    <svg
      viewBox="0 0 24 24"
...
Bookmark3LineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const Bookmark3LineIcon = withWrapper(Bookmark3LineIconComponent);
export default Bookmark3LineIcon;
