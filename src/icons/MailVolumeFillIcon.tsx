...
const MailVolumeFillIconComponent = (p: SVGComponentProps) => {
...
MailVolumeFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const MailVolumeFillIcon = withWrapper(MailVolumeFillIconComponent);
