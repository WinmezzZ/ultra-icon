...
const HammerLineIconComponent = (p: SVGComponentProps) => {
...
HammerLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const HammerLineIcon = withWrapper(HammerLineIconComponent);
export default HammerLineIcon;
