...
const HotAirBalloonIconComponent = (p: SVGComponentProps) => {
...
HotAirBalloonIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const HotAirBalloonIcon = withWrapper(HotAirBalloonIconComponent);
