...
const DataSwitchingIconComponent = (p: SVGComponentProps) => {
...
DataSwitchingIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const DataSwitchingIcon = withWrapper(DataSwitchingIconComponent);
