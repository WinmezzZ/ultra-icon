...
const TShirtLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
TShirtLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const TShirtLineIcon = withWrapper(TShirtLineIconComponent);
export default TShirtLineIcon;
