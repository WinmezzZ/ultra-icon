...
const ShoppingCartFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
ShoppingCartFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const ShoppingCartFillIcon = withWrapper(ShoppingCartFillIconComponent);
