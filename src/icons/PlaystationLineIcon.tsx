...
const PlaystationLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
PlaystationLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const PlaystationLineIcon = withWrapper(PlaystationLineIconComponent);
export default PlaystationLineIcon;
