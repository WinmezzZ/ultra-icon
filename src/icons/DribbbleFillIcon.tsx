...
const DribbbleFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
DribbbleFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const DribbbleFillIcon = withWrapper(DribbbleFillIconComponent);
export default DribbbleFillIcon;
