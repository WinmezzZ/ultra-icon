...
const FilmLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
FilmLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const FilmLineIcon = withWrapper(FilmLineIconComponent);
export default FilmLineIcon;
