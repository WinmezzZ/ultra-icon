...
const FolderWarningLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
FolderWarningLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const FolderWarningLineIcon = withWrapper(FolderWarningLineIconComponent);
