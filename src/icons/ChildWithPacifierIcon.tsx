...
const ChildWithPacifierIconComponent = (p: SVGComponentProps) => {
...
ChildWithPacifierIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const ChildWithPacifierIcon = withWrapper(ChildWithPacifierIconComponent);
