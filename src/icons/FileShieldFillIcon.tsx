...
const FileShieldFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
FileShieldFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const FileShieldFillIcon = withWrapper(FileShieldFillIconComponent);
