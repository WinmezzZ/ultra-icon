...
const StorageCardOneIconComponent = (p: SVGComponentProps) => {
...
StorageCardOneIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const StorageCardOneIcon = withWrapper(StorageCardOneIconComponent);
