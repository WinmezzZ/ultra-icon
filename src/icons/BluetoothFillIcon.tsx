...
const BluetoothFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
BluetoothFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const BluetoothFillIcon = withWrapper(BluetoothFillIconComponent);
export default BluetoothFillIcon;
