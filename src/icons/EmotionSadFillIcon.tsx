...
const EmotionSadFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
EmotionSadFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const EmotionSadFillIcon = withWrapper(EmotionSadFillIconComponent);
export default EmotionSadFillIcon;
