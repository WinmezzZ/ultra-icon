...
const HoldInterfaceIconComponent = (p: SVGComponentProps) => {
...
HoldInterfaceIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const HoldInterfaceIcon = withWrapper(HoldInterfaceIconComponent);
