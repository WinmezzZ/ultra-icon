...
const FlightLandLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
FlightLandLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const FlightLandLineIcon = withWrapper(FlightLandLineIconComponent);
