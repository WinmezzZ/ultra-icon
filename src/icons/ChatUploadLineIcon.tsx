...
const ChatUploadLineIconComponent = (p: SVGComponentProps) => {
...
ChatUploadLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const ChatUploadLineIcon = withWrapper(ChatUploadLineIconComponent);
