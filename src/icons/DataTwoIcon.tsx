...
const DataTwoIconComponent = (p: SVGComponentProps) => {
...
DataTwoIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const DataTwoIcon = withWrapper(DataTwoIconComponent);
export default DataTwoIcon;
