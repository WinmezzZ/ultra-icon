...
const CodeBoxLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
CodeBoxLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const CodeBoxLineIcon = withWrapper(CodeBoxLineIconComponent);
export default CodeBoxLineIcon;
