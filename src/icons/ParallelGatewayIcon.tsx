...
const ParallelGatewayIconComponent = (p: SVGComponentProps) => {
...
ParallelGatewayIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const ParallelGatewayIcon = withWrapper(ParallelGatewayIconComponent);
