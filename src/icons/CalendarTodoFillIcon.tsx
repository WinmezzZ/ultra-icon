...
const CalendarTodoFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
CalendarTodoFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const CalendarTodoFillIcon = withWrapper(CalendarTodoFillIconComponent);
