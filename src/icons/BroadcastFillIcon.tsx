...
const BroadcastFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
BroadcastFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const BroadcastFillIcon = withWrapper(BroadcastFillIconComponent);
export default BroadcastFillIcon;
