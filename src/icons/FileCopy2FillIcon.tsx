...
const FileCopy2FillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
FileCopy2FillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const FileCopy2FillIcon = withWrapper(FileCopy2FillIconComponent);
