...
const ApplicationOneIconComponent = (p: SVGComponentProps) => {
...
ApplicationOneIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const ApplicationOneIcon = withWrapper(ApplicationOneIconComponent);
