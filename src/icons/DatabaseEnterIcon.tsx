...
const DatabaseEnterIconComponent = (p: SVGComponentProps) => {
  ...
  return (
    <svg fill="none" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" width={size} height={size} {...props}>
      ...
      />
      <path stroke="#333" strokeLinecap="round" strokeLinejoin="round" strokeWidth={4} d="m39 31-4-4m4 4-4 4m4-4H29" />
    </svg>
  );
};

DatabaseEnterIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const DatabaseEnterIcon = withWrapper(DatabaseEnterIconComponent);
export default DatabaseEnterIcon;
