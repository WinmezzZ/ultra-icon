...
const SnapchatLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
SnapchatLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const SnapchatLineIcon = withWrapper(SnapchatLineIconComponent);
export default SnapchatLineIcon;
