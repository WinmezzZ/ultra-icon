...
const FolderCodeOneIconComponent = (p: SVGComponentProps) => {
...
FolderCodeOneIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const FolderCodeOneIcon = withWrapper(FolderCodeOneIconComponent);
