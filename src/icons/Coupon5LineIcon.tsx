...
const Coupon5LineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
Coupon5LineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const Coupon5LineIcon = withWrapper(Coupon5LineIconComponent);
export default Coupon5LineIcon;
