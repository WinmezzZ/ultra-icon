...
const SteamFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
SteamFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const SteamFillIcon = withWrapper(SteamFillIconComponent);
export default SteamFillIcon;
