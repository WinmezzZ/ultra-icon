...
const FolderTransferLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
FolderTransferLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const FolderTransferLineIcon = withWrapper(FolderTransferLineIconComponent);
