...
const MicrophoneFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
MicrophoneFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const MicrophoneFillIcon = withWrapper(MicrophoneFillIconComponent);
