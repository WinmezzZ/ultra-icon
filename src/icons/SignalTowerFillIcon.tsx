...
const SignalTowerFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
SignalTowerFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const SignalTowerFillIcon = withWrapper(SignalTowerFillIconComponent);
