...
const FilmFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
FilmFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const FilmFillIcon = withWrapper(FilmFillIconComponent);
export default FilmFillIcon;
