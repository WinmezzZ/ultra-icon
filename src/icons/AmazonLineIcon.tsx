...
const AmazonLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
    <svg
      viewBox="0 0 24 24"
...
AmazonLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const AmazonLineIcon = withWrapper(AmazonLineIconComponent);
export default AmazonLineIcon;
