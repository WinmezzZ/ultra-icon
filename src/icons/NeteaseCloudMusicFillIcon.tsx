...
const NeteaseCloudMusicFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
    <svg
      viewBox="0 0 24 24"
...
NeteaseCloudMusicFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const NeteaseCloudMusicFillIcon = withWrapper(NeteaseCloudMusicFillIconComponent);
export default NeteaseCloudMusicFillIcon;
