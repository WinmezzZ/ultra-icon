...
const SolarEnergyOneIconComponent = (p: SVGComponentProps) => {
...
SolarEnergyOneIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const SolarEnergyOneIcon = withWrapper(SolarEnergyOneIconComponent);
