...
const FileHistoryLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
FileHistoryLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const FileHistoryLineIcon = withWrapper(FileHistoryLineIconComponent);
