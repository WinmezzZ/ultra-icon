...
const MailSettingsFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
MailSettingsFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const MailSettingsFillIcon = withWrapper(MailSettingsFillIconComponent);
export default MailSettingsFillIcon;
