...
const ExchangeCnyLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
ExchangeCnyLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const ExchangeCnyLineIcon = withWrapper(ExchangeCnyLineIconComponent);
export default ExchangeCnyLineIcon;
