...
const ExchangeFundsLineIconComponent = (p: SVGComponentProps) => {
...
ExchangeFundsLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const ExchangeFundsLineIcon = withWrapper(ExchangeFundsLineIconComponent);
export default ExchangeFundsLineIcon;
