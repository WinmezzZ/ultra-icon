...
const GhostSmileLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
GhostSmileLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const GhostSmileLineIcon = withWrapper(GhostSmileLineIconComponent);
