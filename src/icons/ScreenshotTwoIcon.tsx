...
const ScreenshotTwoIconComponent = (p: SVGComponentProps) => {
...
ScreenshotTwoIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const ScreenshotTwoIcon = withWrapper(ScreenshotTwoIconComponent);
