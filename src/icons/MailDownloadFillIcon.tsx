...
const MailDownloadFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
MailDownloadFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const MailDownloadFillIcon = withWrapper(MailDownloadFillIconComponent);
export default MailDownloadFillIcon;
