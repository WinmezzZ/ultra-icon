...
const NotificationLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
NotificationLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const NotificationLineIcon = withWrapper(NotificationLineIconComponent);
