...
const ExclusiveGatewayIconComponent = (p: SVGComponentProps) => {
...
ExclusiveGatewayIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const ExclusiveGatewayIcon = withWrapper(ExclusiveGatewayIconComponent);
