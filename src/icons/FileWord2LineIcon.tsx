...
const FileWord2LineIconComponent = (p: SVGComponentProps) => {
...
FileWord2LineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const FileWord2LineIcon = withWrapper(FileWord2LineIconComponent);
export default FileWord2LineIcon;
