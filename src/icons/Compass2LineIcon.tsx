...
const Compass2LineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
Compass2LineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const Compass2LineIcon = withWrapper(Compass2LineIconComponent);
export default Compass2LineIcon;
