...
const InnerShadowBottomRightIconComponent = (p: SVGComponentProps) => {
...
InnerShadowBottomRightIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const InnerShadowBottomRightIcon = withWrapper(InnerShadowBottomRightIconComponent);
