...
const CodeSSlashFillIconComponent = (p: SVGComponentProps) => {
...
CodeSSlashFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const CodeSSlashFillIcon = withWrapper(CodeSSlashFillIconComponent);
export default CodeSSlashFillIcon;
