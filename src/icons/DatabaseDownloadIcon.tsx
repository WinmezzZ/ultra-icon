...
const DatabaseDownloadIconComponent = (p: SVGComponentProps) => {
  ...
  return (
    <svg fill="none" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" width={size} height={size} {...props}>
      ...
      />
      <path stroke="#333" strokeLinecap="round" strokeLinejoin="round" strokeWidth={4} d="M34 26v10m0 0 4-4m-4 4-4-4" />
    </svg>
  );
};

DatabaseDownloadIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const DatabaseDownloadIcon = withWrapper(DatabaseDownloadIconComponent);
