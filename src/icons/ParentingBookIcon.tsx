...
const ParentingBookIconComponent = (p: SVGComponentProps) => {
...
ParentingBookIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const ParentingBookIcon = withWrapper(ParentingBookIconComponent);
