...
const StethoscopeLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
StethoscopeLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const StethoscopeLineIcon = withWrapper(StethoscopeLineIconComponent);
