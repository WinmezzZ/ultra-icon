...
const FilePdfLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
FilePdfLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const FilePdfLineIcon = withWrapper(FilePdfLineIconComponent);
export default FilePdfLineIcon;
