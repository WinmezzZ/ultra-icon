...
const MicrophoneOffFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
MicrophoneOffFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const MicrophoneOffFillIcon = withWrapper(MicrophoneOffFillIconComponent);
export default MicrophoneOffFillIcon;
