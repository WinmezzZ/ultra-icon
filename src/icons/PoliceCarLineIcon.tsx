...
const PoliceCarLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
PoliceCarLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const PoliceCarLineIcon = withWrapper(PoliceCarLineIconComponent);
