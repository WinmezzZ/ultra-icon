...
const DrawImageLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
DrawImageLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const DrawImageLineIcon = withWrapper(DrawImageLineIconComponent);
export default DrawImageLineIcon;
