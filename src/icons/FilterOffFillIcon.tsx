...
const FilterOffFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
FilterOffFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const FilterOffFillIcon = withWrapper(FilterOffFillIconComponent);
