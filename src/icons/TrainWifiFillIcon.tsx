...
const TrainWifiFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
TrainWifiFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const TrainWifiFillIcon = withWrapper(TrainWifiFillIconComponent);
export default TrainWifiFillIcon;
