...
const SnowyFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
    <svg
      viewBox="0 0 24 24"
...
SnowyFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const SnowyFillIcon = withWrapper(SnowyFillIconComponent);
export default SnowyFillIcon;
