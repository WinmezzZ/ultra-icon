...
const LockPasswordFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
LockPasswordFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const LockPasswordFillIcon = withWrapper(LockPasswordFillIconComponent);
