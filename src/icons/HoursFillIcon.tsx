...
const HoursFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
HoursFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const HoursFillIcon = withWrapper(HoursFillIconComponent);
export default HoursFillIcon;
