...
const ShareCircleFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
ShareCircleFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const ShareCircleFillIcon = withWrapper(ShareCircleFillIconComponent);
export default ShareCircleFillIcon;
