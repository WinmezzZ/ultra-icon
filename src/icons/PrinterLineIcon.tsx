...
const PrinterLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
PrinterLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const PrinterLineIcon = withWrapper(PrinterLineIconComponent);
export default PrinterLineIcon;
