...
const ConnectionArrowIconComponent = (p: SVGComponentProps) => {
...
ConnectionArrowIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const ConnectionArrowIcon = withWrapper(ConnectionArrowIconComponent);
