...
const NewspaperLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
NewspaperLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const NewspaperLineIcon = withWrapper(NewspaperLineIconComponent);
export default NewspaperLineIcon;
