...
const DatabaseConfigIconComponent = (p: SVGComponentProps) => {
  ...
  return (
    <svg fill="none" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" width={size} height={size} {...props}>
      ...
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={4}
        d="M34 27v4m3.464-2L34 31m3.464 2L34 31m0 4v-4m-3.464 2L34 31m-3.464-2L34 31"
      />
    </svg>
  );
};

DatabaseConfigIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const DatabaseConfigIcon = withWrapper(DatabaseConfigIconComponent);
export default DatabaseConfigIcon;
