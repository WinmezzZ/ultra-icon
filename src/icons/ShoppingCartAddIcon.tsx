...
const ShoppingCartAddIconComponent = (p: SVGComponentProps) => {
...
ShoppingCartAddIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const ShoppingCartAddIcon = withWrapper(ShoppingCartAddIconComponent);
