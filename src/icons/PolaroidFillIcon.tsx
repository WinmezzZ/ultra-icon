...
const PolaroidFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
    <svg
      viewBox="0 0 24 24"
...
PolaroidFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const PolaroidFillIcon = withWrapper(PolaroidFillIconComponent);
export default PolaroidFillIcon;
