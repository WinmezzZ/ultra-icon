...
const MicroscopeOneIconComponent = (p: SVGComponentProps) => {
...
MicroscopeOneIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const MicroscopeOneIcon = withWrapper(MicroscopeOneIconComponent);
