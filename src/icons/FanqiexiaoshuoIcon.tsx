...
const FanqiexiaoshuoIconComponent = (p: SVGComponentProps) => {
...
FanqiexiaoshuoIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const FanqiexiaoshuoIcon = withWrapper(FanqiexiaoshuoIconComponent);
