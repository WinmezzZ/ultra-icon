...
const BowIconComponent = (p: SVGComponentProps) => {
  ...
  return (
    <svg fill="none" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" width={size} height={size} {...props}>
      ...
      />
      <path fill="null" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth={4} d="M20 21h8v8h-8z" />
    </svg>
  );
};

BowIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const BowIcon = withWrapper(BowIconComponent);
