...
const TerminationFileIconComponent = (p: SVGComponentProps) => {
...
TerminationFileIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const TerminationFileIcon = withWrapper(TerminationFileIconComponent);
