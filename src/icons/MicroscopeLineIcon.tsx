...
const MicroscopeLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
MicroscopeLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const MicroscopeLineIcon = withWrapper(MicroscopeLineIconComponent);
