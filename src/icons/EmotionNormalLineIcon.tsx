...
const EmotionNormalLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
EmotionNormalLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const EmotionNormalLineIcon = withWrapper(EmotionNormalLineIconComponent);
