...
const NeuralIconComponent = (p: SVGComponentProps) => {
  ...
  return (
    <svg fill="none" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" width={size} height={size} {...props}>
      ...
      <path
        ...
        clipRule="evenodd"
      />
      <path fill="null" stroke="#333" strokeLinejoin="round" strokeWidth={4} d="M20 22a4 4 0 1 0 0-8 4 4 0 0 0 0 8Z" />
      <path
        stroke="#000"
        strokeLinecap="round"
        strokeWidth={4}
...
NeuralIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const NeuralIcon = withWrapper(NeuralIconComponent);
