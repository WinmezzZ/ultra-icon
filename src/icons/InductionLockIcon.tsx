...
const InductionLockIconComponent = (p: SVGComponentProps) => {
...
InductionLockIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const InductionLockIcon = withWrapper(InductionLockIconComponent);
