...
const QuestionnaireLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
QuestionnaireLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const QuestionnaireLineIcon = withWrapper(QuestionnaireLineIconComponent);
export default QuestionnaireLineIcon;
