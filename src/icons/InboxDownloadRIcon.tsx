...
const InboxDownloadRIconComponent = (p: SVGComponentProps) => {
...
InboxDownloadRIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const InboxDownloadRIcon = withWrapper(InboxDownloadRIconComponent);
