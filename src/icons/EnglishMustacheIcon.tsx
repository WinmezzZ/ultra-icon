...
const EnglishMustacheIconComponent = (p: SVGComponentProps) => {
...
EnglishMustacheIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const EnglishMustacheIcon = withWrapper(EnglishMustacheIconComponent);
