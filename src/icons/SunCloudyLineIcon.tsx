...
const SunCloudyLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
SunCloudyLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const SunCloudyLineIcon = withWrapper(SunCloudyLineIconComponent);
