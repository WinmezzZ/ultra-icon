...
const UserSettingsFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
    <svg
      viewBox="0 0 24 24"
...
UserSettingsFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const UserSettingsFillIcon = withWrapper(UserSettingsFillIconComponent);
export default UserSettingsFillIcon;
