...
const BusWifiLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
BusWifiLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const BusWifiLineIcon = withWrapper(BusWifiLineIconComponent);
export default BusWifiLineIcon;
