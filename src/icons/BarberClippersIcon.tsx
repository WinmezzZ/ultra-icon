...
const BarberClippersIconComponent = (p: SVGComponentProps) => {
...
BarberClippersIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const BarberClippersIcon = withWrapper(BarberClippersIconComponent);
