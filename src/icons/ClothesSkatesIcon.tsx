...
const ClothesSkatesIconComponent = (p: SVGComponentProps) => {
...
ClothesSkatesIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const ClothesSkatesIcon = withWrapper(ClothesSkatesIconComponent);
