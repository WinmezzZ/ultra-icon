...
const VegetableBasketIconComponent = (p: SVGComponentProps) => {
...
VegetableBasketIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const VegetableBasketIcon = withWrapper(VegetableBasketIconComponent);
