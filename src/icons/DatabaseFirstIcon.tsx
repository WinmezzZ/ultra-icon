...
const DatabaseFirstIconComponent = (p: SVGComponentProps) => {
  ...
  return (
    <svg fill="none" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" width={size} height={size} {...props}>
      ...
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={4}
        d="M34 35v-8l-2 2m2 6h2m-2 0h-2"
      />
    </svg>
  );
};

DatabaseFirstIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const DatabaseFirstIcon = withWrapper(DatabaseFirstIconComponent);
export default DatabaseFirstIcon;
