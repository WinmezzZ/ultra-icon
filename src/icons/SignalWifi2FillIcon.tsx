...
const SignalWifi2FillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
SignalWifi2FillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const SignalWifi2FillIcon = withWrapper(SignalWifi2FillIconComponent);
export default SignalWifi2FillIcon;
