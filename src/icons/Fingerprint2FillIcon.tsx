...
const Fingerprint2FillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
Fingerprint2FillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const Fingerprint2FillIcon = withWrapper(Fingerprint2FillIconComponent);
export default Fingerprint2FillIcon;
