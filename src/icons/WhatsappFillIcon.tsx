...
const WhatsappFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
WhatsappFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const WhatsappFillIcon = withWrapper(WhatsappFillIconComponent);
export default WhatsappFillIcon;
