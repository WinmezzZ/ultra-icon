...
const MoonClearLineIconComponent = (p: SVGComponentProps) => {
...
MoonClearLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const MoonClearLineIcon = withWrapper(MoonClearLineIconComponent);
