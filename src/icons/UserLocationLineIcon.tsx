...
const UserLocationLineIconComponent = (p: SVGComponentProps) => {
...
UserLocationLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const UserLocationLineIcon = withWrapper(UserLocationLineIconComponent);
export default UserLocationLineIcon;
