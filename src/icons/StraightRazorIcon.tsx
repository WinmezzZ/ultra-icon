...
const StraightRazorIconComponent = (p: SVGComponentProps) => {
...
StraightRazorIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const StraightRazorIcon = withWrapper(StraightRazorIconComponent);
