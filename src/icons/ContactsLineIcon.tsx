...
const ContactsLineIconComponent = (p: SVGComponentProps) => {
...
ContactsLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const ContactsLineIcon = withWrapper(ContactsLineIconComponent);
export default ContactsLineIcon;
