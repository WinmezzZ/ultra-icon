...
const FlightTakeoffFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
FlightTakeoffFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const FlightTakeoffFillIcon = withWrapper(FlightTakeoffFillIconComponent);
