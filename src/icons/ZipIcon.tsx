    ...
    <span css={iconStyle} className="ultra-icon">
      ...
      >
        ...
        <path
          ...
          clipRule="evenodd"
        />
        <path stroke="#fff" strokeLinecap="round" strokeWidth={4} d="M24 22v10" />
        <path
          stroke="#fff"
          strokeWidth={4}
          ...
          clipRule="evenodd"
        />
        <path stroke="#fff" strokeLinecap="round" strokeWidth={4} d="M30 22v10" />
        <path stroke="#fff" strokeLinecap="round" strokeLinejoin="round" strokeWidth={4} d="M12 22h6.005L12 32h6.005" />
      </svg>
    </span>
  );
};
