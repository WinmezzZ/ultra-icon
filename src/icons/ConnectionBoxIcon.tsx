...
const ConnectionBoxIconComponent = (p: SVGComponentProps) => {
...
ConnectionBoxIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const ConnectionBoxIcon = withWrapper(ConnectionBoxIconComponent);
