...
const ArrowLeftCircleLineIconComponent = (p: SVGComponentProps) => {
...
ArrowLeftCircleLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const ArrowLeftCircleLineIcon = withWrapper(ArrowLeftCircleLineIconComponent);
