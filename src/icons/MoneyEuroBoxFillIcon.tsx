...
const MoneyEuroBoxFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
    <svg
      viewBox="0 0 24 24"
...
MoneyEuroBoxFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const MoneyEuroBoxFillIcon = withWrapper(MoneyEuroBoxFillIconComponent);
