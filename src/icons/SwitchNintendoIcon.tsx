...
const SwitchNintendoIconComponent = (p: SVGComponentProps) => {
...
SwitchNintendoIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const SwitchNintendoIcon = withWrapper(SwitchNintendoIconComponent);
