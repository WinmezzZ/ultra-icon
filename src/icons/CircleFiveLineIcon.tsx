...
const CircleFiveLineIconComponent = (p: SVGComponentProps) => {
...
CircleFiveLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const CircleFiveLineIcon = withWrapper(CircleFiveLineIconComponent);
