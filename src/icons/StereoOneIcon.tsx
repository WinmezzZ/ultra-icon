...
const StereoOneIconComponent = (p: SVGComponentProps) => {
...
StereoOneIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const StereoOneIcon = withWrapper(StereoOneIconComponent);
export default StereoOneIcon;
