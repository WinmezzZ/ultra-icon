...
const VideoUploadLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
VideoUploadLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const VideoUploadLineIcon = withWrapper(VideoUploadLineIconComponent);
export default VideoUploadLineIcon;
