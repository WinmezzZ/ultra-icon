...
const ThreeTrianglesIconComponent = (p: SVGComponentProps) => {
...
ThreeTrianglesIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const ThreeTrianglesIcon = withWrapper(ThreeTrianglesIconComponent);
