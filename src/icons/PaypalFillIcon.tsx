...
const PaypalFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
PaypalFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const PaypalFillIcon = withWrapper(PaypalFillIconComponent);
export default PaypalFillIcon;
