...
const PhoneOutgoingOneIconComponent = (p: SVGComponentProps) => {
  ...
  return (
    <svg fill="none" viewBox="0 0 52 51" xmlns="http://www.w3.org/2000/svg" width={size} height={size} {...props}>
      ...
      />
      <path stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth={4} d="m38 6 8 8-8 8m-8-7.992h16" />
    </svg>
  );
};

PhoneOutgoingOneIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const PhoneOutgoingOneIcon = withWrapper(PhoneOutgoingOneIconComponent);
export default PhoneOutgoingOneIcon;
