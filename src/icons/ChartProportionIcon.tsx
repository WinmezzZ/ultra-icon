...
const ChartProportionIconComponent = (p: SVGComponentProps) => {
...
ChartProportionIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const ChartProportionIcon = withWrapper(ChartProportionIconComponent);
