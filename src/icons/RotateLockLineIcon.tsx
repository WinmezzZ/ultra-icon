...
const RotateLockLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
RotateLockLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const RotateLockLineIcon = withWrapper(RotateLockLineIconComponent);
