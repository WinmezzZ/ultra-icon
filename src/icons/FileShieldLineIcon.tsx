...
const FileShieldLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
FileShieldLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const FileShieldLineIcon = withWrapper(FileShieldLineIconComponent);
