...
const PaypalLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
PaypalLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const PaypalLineIcon = withWrapper(PaypalLineIconComponent);
export default PaypalLineIcon;
