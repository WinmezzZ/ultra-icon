...
const FingerprintLineIconComponent = (p: SVGComponentProps) => {
...
FingerprintLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const FingerprintLineIcon = withWrapper(FingerprintLineIconComponent);
export default FingerprintLineIcon;
