...
const MastercardFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
MastercardFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const MastercardFillIcon = withWrapper(MastercardFillIconComponent);
export default MastercardFillIcon;
