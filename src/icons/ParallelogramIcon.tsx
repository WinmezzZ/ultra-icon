...
const ParallelogramIconComponent = (p: SVGComponentProps) => {
...
ParallelogramIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const ParallelogramIcon = withWrapper(ParallelogramIconComponent);
