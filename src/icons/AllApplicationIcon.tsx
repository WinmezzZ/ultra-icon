...
const AllApplicationIconComponent = (p: SVGComponentProps) => {
...
AllApplicationIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const AllApplicationIcon = withWrapper(AllApplicationIconComponent);
