...
const DistributeHorizontallyIconComponent = (p: SVGComponentProps) => {
...
DistributeHorizontallyIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const DistributeHorizontallyIcon = withWrapper(DistributeHorizontallyIconComponent);
