...
const AdobeIndesignIconComponent = (p: SVGComponentProps) => {
...
AdobeIndesignIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const AdobeIndesignIcon = withWrapper(AdobeIndesignIconComponent);
