...
const ClothesGlovesTwoIconComponent = (p: SVGComponentProps) => {
...
ClothesGlovesTwoIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const ClothesGlovesTwoIcon = withWrapper(ClothesGlovesTwoIconComponent);
