...
const AddCircleLineIconComponent = (p: SVGComponentProps) => {
...
AddCircleLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const AddCircleLineIcon = withWrapper(AddCircleLineIconComponent);
