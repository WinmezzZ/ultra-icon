...
const FahrenheitFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
FahrenheitFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const FahrenheitFillIcon = withWrapper(FahrenheitFillIconComponent);
