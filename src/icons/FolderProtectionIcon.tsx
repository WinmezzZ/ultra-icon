...
const FolderProtectionIconComponent = (p: SVGComponentProps) => {
...
FolderProtectionIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const FolderProtectionIcon = withWrapper(FolderProtectionIconComponent);
