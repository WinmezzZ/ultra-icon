...
const DatabasePositionIconComponent = (p: SVGComponentProps) => {
...
DatabasePositionIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const DatabasePositionIcon = withWrapper(DatabasePositionIconComponent);
export default DatabasePositionIcon;
