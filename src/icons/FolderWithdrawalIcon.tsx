  ...
  return (
    <span css={iconStyle} className="ultra-icon">
      ...
      >
        ...
        />
        <path stroke="#fff" strokeLinecap="round" strokeLinejoin="round" strokeWidth={4} d="m21 23-5 5 5 5" />
        <path stroke="#fff" strokeLinecap="round" strokeLinejoin="round" strokeWidth={4} d="M16 28h16v-6" />
      </svg>
    </span>
  );
};
