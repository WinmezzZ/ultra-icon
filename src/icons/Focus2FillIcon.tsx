...
const Focus2FillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
Focus2FillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const Focus2FillIcon = withWrapper(Focus2FillIconComponent);
export default Focus2FillIcon;
