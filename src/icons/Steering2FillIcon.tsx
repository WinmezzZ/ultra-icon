...
const Steering2FillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
Steering2FillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const Steering2FillIcon = withWrapper(Steering2FillIconComponent);
export default Steering2FillIcon;
