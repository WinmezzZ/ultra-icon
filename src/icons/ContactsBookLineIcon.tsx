...
const ContactsBookLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
ContactsBookLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const ContactsBookLineIcon = withWrapper(ContactsBookLineIconComponent);
export default ContactsBookLineIcon;
