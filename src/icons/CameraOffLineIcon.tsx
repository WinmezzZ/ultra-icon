...
const CameraOffLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
CameraOffLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const CameraOffLineIcon = withWrapper(CameraOffLineIconComponent);
