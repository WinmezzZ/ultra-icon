...
const VolumeDownFillIconComponent = (p: SVGComponentProps) => {
...
VolumeDownFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const VolumeDownFillIcon = withWrapper(VolumeDownFillIconComponent);
