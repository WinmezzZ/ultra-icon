...
const MovieFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
MovieFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const MovieFillIcon = withWrapper(MovieFillIconComponent);
export default MovieFillIcon;
