...
const TaxiLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
TaxiLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const TaxiLineIcon = withWrapper(TaxiLineIconComponent);
export default TaxiLineIcon;
