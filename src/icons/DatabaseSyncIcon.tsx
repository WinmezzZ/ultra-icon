...
const DatabaseSyncIconComponent = (p: SVGComponentProps) => {
  ...
  return (
    <svg fill="none" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" width={size} height={size} {...props}>
      ...
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={4}
        d="M38 31a4 4 0 0 1-4 4m-4-4a4 4 0 0 1 4-4"
      />
    </svg>
  );
};

DatabaseSyncIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const DatabaseSyncIcon = withWrapper(DatabaseSyncIconComponent);
