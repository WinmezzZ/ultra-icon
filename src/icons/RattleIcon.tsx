    ...
    <span css={iconStyle} className="ultra-icon">
      ...
      >
        <g stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth={4} clipPath="url(#prefix__a)">
          <circle cx={30.075} cy={15.562} r={11} fill="#2F88FF" transform="rotate(40 30.075 15.562)" />
          ...
          <circle cx={11.24} cy={19.34} r={3} fill="#2F88FF" transform="rotate(40 11.24 19.34)" />
          <circle cx={28.463} cy={37.707} r={3} fill="#2F88FF" transform="rotate(40 28.463 37.707)" />
