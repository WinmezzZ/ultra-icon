...
const ListSettingsLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
ListSettingsLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const ListSettingsLineIcon = withWrapper(ListSettingsLineIconComponent);
