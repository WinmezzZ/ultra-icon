...
const PhoneIncomingOneIconComponent = (p: SVGComponentProps) => {
...
PhoneIncomingOneIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const PhoneIncomingOneIcon = withWrapper(PhoneIncomingOneIconComponent);
