  ...
  return (
    <span css={iconStyle} className="ultra-icon">
      ...
      >
        ...
        />
        <path stroke="#fff" strokeLinecap="round" strokeWidth={4} d="M12 18h24" />
        <path stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth={4} d="M12 15v6m24-6v6" />
        <path fill="#2F88FF" stroke="#000" strokeLinejoin="round" strokeWidth={4} d="M32 4H16v6h16V4Z" />
        <path stroke="#fff" strokeLinecap="round" strokeWidth={4} d="M20 31h8m-4-4v8" />
      </svg>
    </span>
  );
};
