...
const InclusiveGatewayIconComponent = (p: SVGComponentProps) => {
...
InclusiveGatewayIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const InclusiveGatewayIcon = withWrapper(InclusiveGatewayIconComponent);
