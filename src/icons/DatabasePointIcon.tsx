...
const DatabasePointIconComponent = (p: SVGComponentProps) => {
...
DatabasePointIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const DatabasePointIcon = withWrapper(DatabasePointIconComponent);
