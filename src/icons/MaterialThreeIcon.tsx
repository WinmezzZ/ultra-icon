...
const MaterialThreeIconComponent = (p: SVGComponentProps) => {
...
MaterialThreeIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const MaterialThreeIcon = withWrapper(MaterialThreeIconComponent);
