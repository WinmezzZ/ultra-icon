  ...
  return (
    <span css={iconStyle} className="ultra-icon">
      ...
      >
        ...
        />
        <path stroke="#fff" strokeLinecap="round" strokeLinejoin="round" strokeWidth={4} d="m28 20-8 14" />
        <circle cx={24} cy={27} r={8} stroke="#fff" strokeLinecap="round" strokeWidth={4} />
      </svg>
    </span>
  );
};
