...
const MayuraGestureIconComponent = (p: SVGComponentProps) => {
...
MayuraGestureIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const MayuraGestureIcon = withWrapper(MayuraGestureIconComponent);
