...
const FullDressLonguetteIconComponent = (p: SVGComponentProps) => {
...
FullDressLonguetteIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const FullDressLonguetteIcon = withWrapper(FullDressLonguetteIconComponent);
