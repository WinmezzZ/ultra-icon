...
const ThunderstormOneIconComponent = (p: SVGComponentProps) => {
...
ThunderstormOneIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const ThunderstormOneIcon = withWrapper(ThunderstormOneIconComponent);
