  ...
  return (
    <span css={iconStyle} className="ultra-icon">
      ...
      >
        ...
        />
        <circle cx={10} cy={27} r={3} fill="#2F88FF" stroke="#000" strokeWidth={4} />
        <circle cx={24} cy={37} r={3} fill="#2F88FF" stroke="#000" strokeWidth={4} />
        <circle cx={24} cy={7} r={3} fill="#2F88FF" stroke="#000" strokeWidth={4} />
        <circle cx={12} cy={13} r={3} fill="#2F88FF" stroke="#000" strokeWidth={4} />
        <circle cx={36} cy={13} r={3} fill="#2F88FF" stroke="#000" strokeWidth={4} />
        <circle cx={38} cy={27} r={3} fill="#2F88FF" stroke="#000" strokeWidth={4} />
