...
const MergeCellsHorizontalIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
MergeCellsHorizontalIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const MergeCellsHorizontalIcon = withWrapper(MergeCellsHorizontalIconComponent);
