...
const Rocket2FillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
Rocket2FillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const Rocket2FillIcon = withWrapper(Rocket2FillIconComponent);
export default Rocket2FillIcon;
