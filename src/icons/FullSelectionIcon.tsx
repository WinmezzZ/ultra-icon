...
const FullSelectionIconComponent = (p: SVGComponentProps) => {
...
FullSelectionIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const FullSelectionIcon = withWrapper(FullSelectionIconComponent);
