...
const XboxLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
XboxLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const XboxLineIcon = withWrapper(XboxLineIconComponent);
export default XboxLineIcon;
