...
const TaobaoFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
TaobaoFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const TaobaoFillIcon = withWrapper(TaobaoFillIconComponent);
export default TaobaoFillIcon;
