...
const KnifeLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
KnifeLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const KnifeLineIcon = withWrapper(KnifeLineIconComponent);
export default KnifeLineIcon;
