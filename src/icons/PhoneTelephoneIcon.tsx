...
const PhoneTelephoneIconComponent = (p: SVGComponentProps) => {
...
PhoneTelephoneIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const PhoneTelephoneIcon = withWrapper(PhoneTelephoneIconComponent);
