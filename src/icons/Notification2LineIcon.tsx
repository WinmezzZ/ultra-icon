...
const Notification2LineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
Notification2LineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const Notification2LineIcon = withWrapper(Notification2LineIconComponent);
