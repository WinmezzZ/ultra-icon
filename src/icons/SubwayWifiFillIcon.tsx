...
const SubwayWifiFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
SubwayWifiFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const SubwayWifiFillIcon = withWrapper(SubwayWifiFillIconComponent);
export default SubwayWifiFillIcon;
