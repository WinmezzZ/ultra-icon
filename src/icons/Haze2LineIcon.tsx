...
const Haze2LineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
Haze2LineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const Haze2LineIcon = withWrapper(Haze2LineIconComponent);
export default Haze2LineIcon;
