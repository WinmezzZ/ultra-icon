...
const GreenNewEnergyIconComponent = (p: SVGComponentProps) => {
...
GreenNewEnergyIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const GreenNewEnergyIcon = withWrapper(GreenNewEnergyIconComponent);
