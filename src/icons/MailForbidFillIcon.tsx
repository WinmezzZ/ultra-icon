...
const MailForbidFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
MailForbidFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const MailForbidFillIcon = withWrapper(MailForbidFillIconComponent);
