...
const HomeHeartLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
HomeHeartLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const HomeHeartLineIcon = withWrapper(HomeHeartLineIconComponent);
