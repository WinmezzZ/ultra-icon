...
const TwitchFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
TwitchFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const TwitchFillIcon = withWrapper(TwitchFillIconComponent);
export default TwitchFillIcon;
