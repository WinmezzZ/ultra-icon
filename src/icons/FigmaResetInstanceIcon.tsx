...
const FigmaResetInstanceIconComponent = (p: SVGComponentProps) => {
...
FigmaResetInstanceIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const FigmaResetInstanceIcon = withWrapper(FigmaResetInstanceIconComponent);
