...
const PlugFillIconComponent = (p: SVGComponentProps) => {
...
PlugFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const PlugFillIcon = withWrapper(PlugFillIconComponent);
export default PlugFillIcon;
