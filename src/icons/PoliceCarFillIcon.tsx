...
const PoliceCarFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
    <svg
      viewBox="0 0 24 24"
...
PoliceCarFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const PoliceCarFillIcon = withWrapper(PoliceCarFillIconComponent);
export default PoliceCarFillIcon;
