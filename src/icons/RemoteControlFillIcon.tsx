...
const RemoteControlFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
RemoteControlFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const RemoteControlFillIcon = withWrapper(RemoteControlFillIconComponent);
export default RemoteControlFillIcon;
