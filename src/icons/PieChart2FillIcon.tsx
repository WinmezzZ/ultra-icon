...
const PieChart2FillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
PieChart2FillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const PieChart2FillIcon = withWrapper(PieChart2FillIconComponent);
