...
const RestaurantLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
RestaurantLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const RestaurantLineIcon = withWrapper(RestaurantLineIconComponent);
