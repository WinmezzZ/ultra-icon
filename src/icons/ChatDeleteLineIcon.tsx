...
const ChatDeleteLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
    <svg
      viewBox="0 0 24 24"
...
ChatDeleteLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const ChatDeleteLineIcon = withWrapper(ChatDeleteLineIconComponent);
