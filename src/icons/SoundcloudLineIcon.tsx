...
const SoundcloudLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
SoundcloudLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const SoundcloudLineIcon = withWrapper(SoundcloudLineIconComponent);
export default SoundcloudLineIcon;
