  ...
  return (
    <span css={iconStyle} className="ultra-icon">
      ...
      >
        ...
        <path stroke="#fff" strokeLinecap="round" strokeLinejoin="round" strokeWidth={4} d="M26 24v6" />
        <path
          stroke="#fff"
          strokeLinejoin="round"
          strokeWidth={4}
        ...
        />
        <path stroke="#fff" strokeLinecap="round" strokeLinejoin="round" strokeWidth={4} d="m31 25-5-1" />
      </svg>
    </span>
  );
};
