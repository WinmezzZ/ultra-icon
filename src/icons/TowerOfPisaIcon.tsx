...
const TowerOfPisaIconComponent = (p: SVGComponentProps) => {
  ...
  return (
    <svg fill="none" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" width={size} height={size} {...props}>
      <g stroke="#000" strokeWidth={4} clipPath="url(#prefix__a)">
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="m19.317 6.957 19.319 5.176m-22.425 6.415 19.319 5.177" />
...
TowerOfPisaIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const TowerOfPisaIcon = withWrapper(TowerOfPisaIconComponent);
