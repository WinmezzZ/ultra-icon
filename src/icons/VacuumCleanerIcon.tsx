...
const VacuumCleanerIconComponent = (p: SVGComponentProps) => {
...
VacuumCleanerIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const VacuumCleanerIcon = withWrapper(VacuumCleanerIconComponent);
