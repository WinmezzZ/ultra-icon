...
const MoneyCnyCircleFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
    <svg
      viewBox="0 0 24 24"
...
MoneyCnyCircleFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const MoneyCnyCircleFillIcon = withWrapper(MoneyCnyCircleFillIconComponent);
