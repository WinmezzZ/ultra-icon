...
const OrangeStationIconComponent = (p: SVGComponentProps) => {
...
OrangeStationIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const OrangeStationIcon = withWrapper(OrangeStationIconComponent);
