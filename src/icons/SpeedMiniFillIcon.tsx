...
const SpeedMiniFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
SpeedMiniFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const SpeedMiniFillIcon = withWrapper(SpeedMiniFillIconComponent);
export default SpeedMiniFillIcon;
