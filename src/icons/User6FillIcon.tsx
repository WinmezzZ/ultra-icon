...
const User6FillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
User6FillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const User6FillIcon = withWrapper(User6FillIconComponent);
export default User6FillIcon;
