...
const VipCrown2FillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
VipCrown2FillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const VipCrown2FillIcon = withWrapper(VipCrown2FillIconComponent);
export default VipCrown2FillIcon;
