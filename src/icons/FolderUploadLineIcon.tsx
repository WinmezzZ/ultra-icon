...
const FolderUploadLineIconComponent = (p: SVGComponentProps) => {
...
FolderUploadLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const FolderUploadLineIcon = withWrapper(FolderUploadLineIconComponent);
