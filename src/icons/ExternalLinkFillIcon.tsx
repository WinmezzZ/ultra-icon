...
const ExternalLinkFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
ExternalLinkFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const ExternalLinkFillIcon = withWrapper(ExternalLinkFillIconComponent);
