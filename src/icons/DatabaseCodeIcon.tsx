...
const DatabaseCodeIconComponent = (p: SVGComponentProps) => {
  ...
  return (
    <svg fill="none" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" width={size} height={size} {...props}>
      ...
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={4}
        d="m37 29 2 2-2 2m-6 0-2-2 2-2"
      />
    </svg>
  );
};

DatabaseCodeIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const DatabaseCodeIcon = withWrapper(DatabaseCodeIconComponent);
export default DatabaseCodeIcon;
