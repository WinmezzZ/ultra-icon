...
const GitPullRequestLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
GitPullRequestLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const GitPullRequestLineIcon = withWrapper(GitPullRequestLineIconComponent);
