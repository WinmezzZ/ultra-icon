  ...
  return (
    <span css={iconStyle} className="ultra-icon">
      <svg
        ...
        {...props}
      >
        <rect width={40} height={30} x={4} y={9} fill="#2F88FF" stroke="#000" strokeWidth={4} rx={2} />
        <path stroke="#fff" strokeLinecap="round" strokeLinejoin="round" strokeWidth={4} d="M16 9v30" />
