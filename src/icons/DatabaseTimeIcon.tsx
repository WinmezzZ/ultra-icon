...
const DatabaseTimeIconComponent = (p: SVGComponentProps) => {
  ...
  return (
    <svg fill="none" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" width={size} height={size} {...props}>
      ...
      />
      <path stroke="#333" strokeLinecap="round" strokeLinejoin="round" strokeWidth={4} d="M38 31h-4v-4" />
    </svg>
  );
};

DatabaseTimeIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const DatabaseTimeIcon = withWrapper(DatabaseTimeIconComponent);
export default DatabaseTimeIcon;
