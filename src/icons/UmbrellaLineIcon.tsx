...
const UmbrellaLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
UmbrellaLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const UmbrellaLineIcon = withWrapper(UmbrellaLineIconComponent);
export default UmbrellaLineIcon;
