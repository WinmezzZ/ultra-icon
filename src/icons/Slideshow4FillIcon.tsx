...
const Slideshow4FillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
Slideshow4FillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const Slideshow4FillIcon = withWrapper(Slideshow4FillIconComponent);
export default Slideshow4FillIcon;
