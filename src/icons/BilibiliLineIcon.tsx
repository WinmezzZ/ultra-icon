...
const BilibiliLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
BilibiliLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const BilibiliLineIcon = withWrapper(BilibiliLineIconComponent);
export default BilibiliLineIcon;
