...
const FourKFillIconComponent = (p: SVGComponentProps) => {
...
FourKFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const FourKFillIcon = withWrapper(FourKFillIconComponent);
export default FourKFillIcon;
