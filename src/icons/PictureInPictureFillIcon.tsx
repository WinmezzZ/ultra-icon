...
const PictureInPictureFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
PictureInPictureFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const PictureInPictureFillIcon = withWrapper(PictureInPictureFillIconComponent);
