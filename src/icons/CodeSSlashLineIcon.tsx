...
const CodeSSlashLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
CodeSSlashLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const CodeSSlashLineIcon = withWrapper(CodeSSlashLineIconComponent);
export default CodeSSlashLineIcon;
