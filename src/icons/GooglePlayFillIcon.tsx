...
const GooglePlayFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
GooglePlayFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const GooglePlayFillIcon = withWrapper(GooglePlayFillIconComponent);
