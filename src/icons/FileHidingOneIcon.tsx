...
const FileHidingOneIconComponent = (p: SVGComponentProps) => {
...
FileHidingOneIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const FileHidingOneIcon = withWrapper(FileHidingOneIconComponent);
