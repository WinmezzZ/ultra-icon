...
const EarthquakeLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
EarthquakeLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const EarthquakeLineIcon = withWrapper(EarthquakeLineIconComponent);
