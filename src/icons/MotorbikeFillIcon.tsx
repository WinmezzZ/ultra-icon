...
const MotorbikeFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
MotorbikeFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const MotorbikeFillIcon = withWrapper(MotorbikeFillIconComponent);
export default MotorbikeFillIcon;
