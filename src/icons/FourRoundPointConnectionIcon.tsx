...
const FourRoundPointConnectionIconComponent = (p: SVGComponentProps) => {
...
FourRoundPointConnectionIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const FourRoundPointConnectionIcon = withWrapper(FourRoundPointConnectionIconComponent);
