...
const PlayCircleFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
PlayCircleFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const PlayCircleFillIcon = withWrapper(PlayCircleFillIconComponent);
