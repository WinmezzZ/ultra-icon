...
const VisaFillIconComponent = (p: SVGComponentProps) => {
...
VisaFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const VisaFillIcon = withWrapper(VisaFillIconComponent);
export default VisaFillIcon;
