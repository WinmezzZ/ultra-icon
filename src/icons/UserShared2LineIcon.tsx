...
const UserShared2LineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
UserShared2LineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const UserShared2LineIcon = withWrapper(UserShared2LineIconComponent);
export default UserShared2LineIcon;
