...
const ClipboardFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
ClipboardFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const ClipboardFillIcon = withWrapper(ClipboardFillIconComponent);
