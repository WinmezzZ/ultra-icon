...
const Focus2LineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
Focus2LineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const Focus2LineIcon = withWrapper(Focus2LineIconComponent);
export default Focus2LineIcon;
