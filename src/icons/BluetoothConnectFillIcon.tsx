...
const BluetoothConnectFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
BluetoothConnectFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const BluetoothConnectFillIcon = withWrapper(BluetoothConnectFillIconComponent);
export default BluetoothConnectFillIcon;
