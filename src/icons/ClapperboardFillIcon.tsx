...
const ClapperboardFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
ClapperboardFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const ClapperboardFillIcon = withWrapper(ClapperboardFillIconComponent);
export default ClapperboardFillIcon;
