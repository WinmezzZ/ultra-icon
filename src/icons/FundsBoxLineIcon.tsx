...
const FundsBoxLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
    <svg
      viewBox="0 0 24 24"
...
FundsBoxLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const FundsBoxLineIcon = withWrapper(FundsBoxLineIconComponent);
export default FundsBoxLineIcon;
