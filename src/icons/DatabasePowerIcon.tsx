...
const DatabasePowerIconComponent = (p: SVGComponentProps) => {
  ...
  return (
    <svg fill="none" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" width={size} height={size} {...props}>
      ...
      />
      <path stroke="#333" strokeLinecap="round" strokeLinejoin="round" strokeWidth={4} d="m34 26-3 4 6 2-3 4" />
    </svg>
  );
};

DatabasePowerIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const DatabasePowerIcon = withWrapper(DatabasePowerIconComponent);
export default DatabasePowerIcon;
