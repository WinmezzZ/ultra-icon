...
const FileList3LineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
FileList3LineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const FileList3LineIcon = withWrapper(FileList3LineIconComponent);
