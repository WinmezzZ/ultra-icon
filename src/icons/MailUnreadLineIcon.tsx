...
const MailUnreadLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
MailUnreadLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const MailUnreadLineIcon = withWrapper(MailUnreadLineIconComponent);
export default MailUnreadLineIcon;
