...
const ProtectIconComponent = (p: SVGComponentProps) => {
  ...
  return (
    <svg fill="none" viewBox="0 0 48 49" xmlns="http://www.w3.org/2000/svg" width={size} height={size} {...props}>
      ...
      />
      <path stroke="#333" strokeLinecap="round" strokeLinejoin="round" strokeWidth={4} d="m15 23 7 7 12-12" />
    </svg>
  );
};

ProtectIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const ProtectIcon = withWrapper(ProtectIconComponent);
