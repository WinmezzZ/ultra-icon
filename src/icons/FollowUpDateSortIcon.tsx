...
const FollowUpDateSortIconComponent = (p: SVGComponentProps) => {
...
FollowUpDateSortIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const FollowUpDateSortIcon = withWrapper(FollowUpDateSortIconComponent);
