...
const ArrowUpCircleLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
ArrowUpCircleLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const ArrowUpCircleLineIcon = withWrapper(ArrowUpCircleLineIconComponent);
