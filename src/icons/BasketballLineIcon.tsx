...
const BasketballLineIconComponent = (p: SVGComponentProps) => {
...
BasketballLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const BasketballLineIcon = withWrapper(BasketballLineIconComponent);
export default BasketballLineIcon;
