...
const UploadCloudLineIconComponent = (p: SVGComponentProps) => {
...
UploadCloudLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const UploadCloudLineIcon = withWrapper(UploadCloudLineIconComponent);
