...
const DeleteBin2LineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
DeleteBin2LineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const DeleteBin2LineIcon = withWrapper(DeleteBin2LineIconComponent);
export default DeleteBin2LineIcon;
