...
const PictureInPictureExitLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
    <svg
      viewBox="0 0 24 24"
...
PictureInPictureExitLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const PictureInPictureExitLineIcon = withWrapper(PictureInPictureExitLineIconComponent);
