...
const BarcodeBoxLineIconComponent = (p: SVGComponentProps) => {
...
BarcodeBoxLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const BarcodeBoxLineIcon = withWrapper(BarcodeBoxLineIconComponent);
