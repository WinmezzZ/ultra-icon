...
const AccountCircleLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
AccountCircleLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const AccountCircleLineIcon = withWrapper(AccountCircleLineIconComponent);
