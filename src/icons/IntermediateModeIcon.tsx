...
const IntermediateModeIconComponent = (p: SVGComponentProps) => {
...
IntermediateModeIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const IntermediateModeIcon = withWrapper(IntermediateModeIconComponent);
