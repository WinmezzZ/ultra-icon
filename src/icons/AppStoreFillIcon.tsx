...
const AppStoreFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
    <svg
      viewBox="0 0 24 24"
...
AppStoreFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const AppStoreFillIcon = withWrapper(AppStoreFillIconComponent);
export default AppStoreFillIcon;
