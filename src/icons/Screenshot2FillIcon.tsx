...
const Screenshot2FillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
Screenshot2FillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const Screenshot2FillIcon = withWrapper(Screenshot2FillIconComponent);
export default Screenshot2FillIcon;
