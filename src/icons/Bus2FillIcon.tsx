...
const Bus2FillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
Bus2FillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const Bus2FillIcon = withWrapper(Bus2FillIconComponent);
export default Bus2FillIcon;
