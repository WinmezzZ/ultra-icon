...
const EditBoxFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
EditBoxFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const EditBoxFillIcon = withWrapper(EditBoxFillIconComponent);
export default EditBoxFillIcon;
