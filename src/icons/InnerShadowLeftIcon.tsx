...
const InnerShadowLeftIconComponent = (p: SVGComponentProps) => {
...
InnerShadowLeftIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const InnerShadowLeftIcon = withWrapper(InnerShadowLeftIconComponent);
