...
const CoordinateSystemIconComponent = (p: SVGComponentProps) => {
...
CoordinateSystemIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const CoordinateSystemIcon = withWrapper(CoordinateSystemIconComponent);
