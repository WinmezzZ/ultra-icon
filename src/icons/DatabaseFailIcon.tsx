...
const DatabaseFailIconComponent = (p: SVGComponentProps) => {
  ...
  return (
    <svg fill="none" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" width={size} height={size} {...props}>
      ...
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={4}
        d="m37 34-3-3m0 0 3-3m-3 3-3-3m3 3-3 3"
      />
    </svg>
  );
};

DatabaseFailIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const DatabaseFailIcon = withWrapper(DatabaseFailIconComponent);
export default DatabaseFailIcon;
