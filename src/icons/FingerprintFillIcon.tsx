...
const FingerprintFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
FingerprintFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const FingerprintFillIcon = withWrapper(FingerprintFillIconComponent);
export default FingerprintFillIcon;
