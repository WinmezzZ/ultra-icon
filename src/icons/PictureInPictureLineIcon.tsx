...
const PictureInPictureLineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
PictureInPictureLineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const PictureInPictureLineIcon = withWrapper(PictureInPictureLineIconComponent);
