...
const Contrast2LineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
    <svg
      viewBox="0 0 24 24"
...
Contrast2LineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const Contrast2LineIcon = withWrapper(Contrast2LineIconComponent);
export default Contrast2LineIcon;
