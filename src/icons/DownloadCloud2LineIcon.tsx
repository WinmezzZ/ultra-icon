...
const DownloadCloud2LineIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
    <svg
      viewBox="0 0 24 24"
...
DownloadCloud2LineIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const DownloadCloud2LineIcon = withWrapper(DownloadCloud2LineIconComponent);
