...
const XboxFillIconComponent = (p: SVGComponentProps) => {
...
XboxFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const XboxFillIcon = withWrapper(XboxFillIconComponent);
export default XboxFillIcon;
