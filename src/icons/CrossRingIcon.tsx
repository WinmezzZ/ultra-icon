      ...
      >
        <g fill="none" fillRule="evenodd" strokeLinejoin="round">
          ...
          <g stroke="#000" strokeWidth={4} transform="translate(4 4)">
            <circle cx={20} cy={4} r={4} fill="#2F88FF" fillRule="nonzero" />
            <circle cx={20} cy={36} r={4} fill="#2F88FF" fillRule="nonzero" />
            <circle cx={4} cy={20} r={4} fill="#2F88FF" fillRule="nonzero" />
            <circle cx={36} cy={20} r={4} fill="#2F88FF" fillRule="nonzero" />
            <path
              strokeLinecap="round"
