...
const Apps2FillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
    <svg
      viewBox="0 0 24 24"
...
Apps2FillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const Apps2FillIcon = withWrapper(Apps2FillIconComponent);
export default Apps2FillIcon;
