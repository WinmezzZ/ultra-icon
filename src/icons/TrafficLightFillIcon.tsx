...
const TrafficLightFillIconComponent = (p: SVGComponentProps) => {
  const { size, ...props } = p;
  return (
...
TrafficLightFillIconComponent.propTypes = {
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
const TrafficLightFillIcon = withWrapper(TrafficLightFillIconComponent);
